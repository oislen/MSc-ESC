...
saveRDS(object = my_model_overall, file = './models/overall_final_model.RDS')
```
...
# write the model to disk
saveRDS(object = my_model_tele, file = './models/televote_final_model.RDS')
```
...
# write the model to disk
saveRDS(object = my_model_jury, file = './models/jury_final_model.RDS')
```
