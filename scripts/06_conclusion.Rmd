...
if (gen_output_model_arch_files) {
  # write the model to disk
  saveRDS(object = my_model_overall, file = fpath_model_arch_overall_final)
}
```
...
if (gen_output_model_arch_files) {
  # write the model to disk
  saveRDS(object = my_model_tele, file = fpath_model_arch_televote_final)
}
```
...
if (gen_output_model_arch_files) {
  # write the model to disk
  saveRDS(object = my_model_jury, file = fpath_model_arch_jury_final)
}
```
