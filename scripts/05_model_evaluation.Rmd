...
```{r overall-outliers, echo = FALSE, warning = FALSE, results = 'hide'}
# Assessing Outliers
...
```{r overall-normality-tests, echo = FALSE, warning = FALSE, results = 'hide'}
# Normality Test
...
```{r televote-outliers, echo = FALSE, warning = FALSE, results = 'hide'}
# Assessing Outliers
# Bonferonni p-value for most extreme obs
...
```{r televote-normality-tests, echo = FALSE, warning = FALSE, results = 'hide'}
# Normality Test
...
```{r jury-standardised-residuals, echo = FALSE, warning = FALSE, results = 'hide'}
# generate standardised residuals
...
```{r jury-outliers, echo = FALSE, warning = FALSE, results = 'hide'}
# Assessing Outliers
# Bonferonni p-value for most extreme obs
...
```{r jury-normality-tests, echo = FALSE, warning = FALSE, results = 'hide'}
# Normality Test
