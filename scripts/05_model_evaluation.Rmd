...
```{r overall-standardise-residuals}
...
```{r overall-nonconstant-variance}
# Non-Constant Error Variance Test
...
```{r televote-standardise-residuals}
# create standardize residuals
...
```{r televote-nonconstant-variance}
# Non-Constant Error Variance Test
