...
graph_network(dataset = filter(networkdata, Voting_Method == "T" & METRIC_COB > 0.1), weights = 'Points', main = 'Televote Metric COB', output_fpath = '../report/plots/networks/televote-metric-cob.jpg')
# (2) Voting_Method = Jury
graph_network(dataset = filter(networkdata, Voting_Method == "J" & METRIC_COB > 0.1), weights = 'Points', main = 'Jury Metric COB', output_fpath = '../report/plots/networks/jury-metric-cob.jpg')
```
...
# (1) Voting_Method = Televote
graph_network(dataset = filter(networkdata, Voting_Method == "T" & METRIC_Citizens > 0.1), weights = 'Points', main = 'Televote Metric Citizens', output_fpath = '../report/plots/networks/televote-metric-citizens.jpg')
# (2) Voting_Method = Jury
graph_network(dataset = filter(networkdata, Voting_Method == "J" & METRIC_Citizens > 0.1), weights = 'Points', main = 'Jury Metric Citizens', output_fpath = '../report/plots/networks/jury-metric-citizens.jpg')
```
...
# (1) Voting_Method = Televote
graph_network(dataset = filter(networkdata, Voting_Method == "T" & METRIC_COBCit > 0.15), weights = 'Points', main = 'Televote Metric COBCit', output_fpath = '../report/plots/networks/televote-metric-cobcit.jpg')
# (2) Voting_Method = Jury
graph_network(dataset = filter(networkdata, Voting_Method == "J" & METRIC_COBCit > 0.15), weights = 'Points', main = 'Jury Metric COBCit', output_fpath = '../report/plots/networks/jury-metric-cobcit.jpg')

# (1) Voting_Method = Televote & Round = sf1
graph_network(dataset = filter(networkdata, Voting_Method == "T" & METRIC_COBCit > 0.25 & Round == "sf1"), weights = 'Points', main = 'Televote Metric COBCit SF1', output_fpath = '../report/plots/networks/televote-metric-cobcit-sf1.jpg')
# (2) Voting_Method = Jury
graph_network(dataset = filter(networkdata, Voting_Method == "J" & METRIC_COBCit > 0.25 & Round == "sf1"), weights = 'Points', main = 'Jury Metric COBCit SF1', output_fpath = '../report/plots/networks/jury-metric-cobcit-sf1.jpg')
```
...
# (1) Voting_Method = Televote
graph_network(dataset = filter(networkdata, Voting_Method == "T" & CAP_DIST_km < 500), weights = 'Points', main = 'Televote Cap Dist', output_fpath = '../report/plots/networks/televote-cap-dist.jpg')
# (2) Voting_Method = Jury
graph_network(dataset = filter(networkdata, Voting_Method == "J" & CAP_DIST_km < 500), weights = 'Points', main = 'Jury Cap Dist', output_fpath = '../report/plots/networks/jury-cap-dist.jpg')
```
...
# (1) Voting_Method = Televote
graph_network(dataset = filter(networkdata, Voting_Method == "T" & Average_Points > 8), weights = 'Average_Points', main = 'Televote Average Points', output_fpath = '../report/plots/networks/televote-average-points.jpg')
# (2) Voting_Method = Jury
graph_network(dataset = filter(networkdata, Voting_Method == "J" & Average_Points > 8), weights = 'Average_Points', main = 'Jury Average Points', output_fpath = '../report/plots/networks/jury-average-points.jpg')
```
