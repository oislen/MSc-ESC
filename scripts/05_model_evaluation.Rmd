...
if (gen_output_report_files) {
  output_fpath <- '../report/plots/boxcox/model_overall_boxcox.jpg'
}
# box-cox transformation using car
bct <- boxcox_transplot(my_model_overall, output_fpath = output_fpath)
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_overall_residuals_vs_fits.jpg'
}
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_overall_cooks.jpg'
}
# Cook's D plot
plot_cooks(
  model = my_model_overall,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_overall_influence.jpg'
}
# Influence Plot 
plot_influence(
  model = my_model_overall,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_overall_residual_distribution.jpg'
}
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_overall_qq.jpg'
}
# QQ-plot of the data
plot_qq(
  my_model_overall,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_overall_spreadlevel.jpg'
}
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/boxcox/model_tele_boxcox.jpg'
}
# box-cox transformation using car
bct <- boxcox_transplot(my_model_tele, output_fpath = output_fpath)
# find optimal box-cox power transformation power
p <- bct$x[which.max(x = bct$y)]
# transform points using the optimal power transformation
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_tele_residuals_vs_fits.jpg'
}
# plot residuals vs fits model
plot_residuals_vs_fits(
  model = my_model_tele,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_tele_cooks.jpg'
}
# Cook's D plot
plot_cooks(
  model = my_model_tele,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_televote_influence.jpg'
}
# Influence Plot 
plot_influence(
  model = my_model_tele,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_televote_residual_distribution.jpg'
}
# plot distribution of residuals
plot_residualdist(
  tele_sresid,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_televote_qq.jpg'
}
# QQ-plot of the data
plot_qq(
  my_model_tele,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_televote_spreadlevel.jpg'
}
# plot studentized residuals vs. fitted values 
plot_spreadlevel(
  my_model_tele,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_jury_residuals_vs_fits.jpg'
}
# plot residuals vs fits model
plot_residuals_vs_fits(
  model = my_model_jury,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_jury_cooks.jpg'
}
# Cook's D plot
plot_cooks(
  model = my_model_jury,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_jury_influence.jpg'
}
# Influence Plot 
plot_influence(
  model = my_model_jury,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_jury_residual_distribution.jpg'
}
# Influence Plot 
plot_residualdist(
  jury_sresid,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_jury_qq.jpg'
}
# QQ-plot of the data
plot_qq(
  my_model_jury,
...
output_fpath <- NA
if (gen_output_report_files) {
  output_fpath <- '../report/plots/residual/model_jury_spreadlevel.jpg'
}
# plot studentized residuals vs. fitted values 
plot_spreadlevel(
  my_model_jury,
