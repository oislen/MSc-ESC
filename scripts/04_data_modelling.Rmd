...
source('utilities/step_lm_model.R')
source('cons.R')
```
...
saveRDS(object = overall_final_model, file = fpath_model_overall_final)
```
...
# write the model to disk
saveRDS(object = televote_final_model, file = fpath_model_televote_final)
```
...
# write the model to disk
saveRDS(object = jury_final_model, file = fpath_model_jury_final)
```
